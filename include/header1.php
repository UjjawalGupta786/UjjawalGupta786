                    ...
                    <div class="row">
                        <div class="col-md-8">
                            <ul class="top-contact list-text-white  d-table">
                                <li><a href="#"><i class="fas fa-phone-alt text-success mr-1"></i>+91 1234567890</a></li>
                                <li><a href="#"><i class="fas fa-envelope text-success mr-1"></i>sample@realestate.com</a></li>
                            </ul>
                        </div>
                        <div class="col-md-4">
                        ...
                        <div class="col-lg-12">
                            <nav class="navbar navbar-expand-lg navbar-light p-0"> <a class="navbar-brand position-relative" href="index.php"><img class="nav-logo" src="images/logo/restatelg.png" alt=""></a>
                                ...
                                <div class="collapse navbar-collapse" id="navbarSupportedContent">
									...
									<a class="btn btn-success d-none d-xl-block" style="border-radius:30px;" href="thanks-you.php">Buy Property</a> 
                                </div>
                            </nav>
                        </div>
                    </div>
