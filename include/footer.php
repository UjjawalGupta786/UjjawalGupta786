<footer class="full-row bg-secondary p-0">
            <div class="container">
                            ...
                            <div class="row">
                                <div class="col-md-12 col-lg-4">
                                    <div class="footer-widget mb-4">
                                        ...
                                        <p class="pb-20 text-white">this is my first Real Estate project.this is my first Real Estate project.this is my first Real Estate project.this is my first Real Estate project.this is my first Real Estate project.this is my first Real Estate project.this is my first Real Estate project.this is my first Real Estate project.this is my first Real Estate project.</p>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4 col-lg-4">
                                            <div class="footer-widget">
                                                ...
                                                <ul class="text-white">
                                                    <li class="hover-text-primary"><i class="fas fa-map-marker-alt text-white mr-2 font-13 mt-1"></i>Naraina Group Of Institution</li>
                                                    <li class="hover-text-primary"> <i class="fas fa-phone-alt text-white mr-2 font-13 mt-1"></i>+91 1234567890</li>
													<li class="hover-text-primary"> <i class="fas fa-phone-alt text-white mr-2 font-13 mt-1"></i>+91 1234567891</li>
                ...
                <div class="row copyright">
                    <div class="col-sm-6"> <span class="text-white">© <?php echo date('Y');?> Real Estate Website - Developed By Ujjawal Gupta</span> </div>
                    <div class="col-sm-6">
